...
do
    taskset -c 46-47 nice -n 46 python inference.py \
        ...
        --output_folder /disk4/chocho/_enhanced-wav/VCTK_DEMAND16k/SEMamba/${SNR} \
        --checkpoint_file /disk4/chocho/SEMamba/exp20250319/SEMamba_v1/g_00118000.pth \
        --config /disk4/chocho/SEMamba/exp20250319/SEMamba_v1/config.yaml \
...
# /disk4/chocho/SEMamba/exp20250330-PCS/SEMamba_v1_PCS/g_00093000.pth